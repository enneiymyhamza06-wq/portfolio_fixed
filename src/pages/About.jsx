...
export default function About() {
  return (
    ...
    >
      ...
      {/* top separator — خط gradient يوصل بين Home و About */}
      ...
      <div className="relative z-10 mx-auto grid min-h-screen max-w-7xl items-center gap-14 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5 backdrop-blur-xl transition duration-300 hover:border-orange-400/20 hover:bg-white/[0.07]">
              <p className="text-[11px] uppercase tracking-[0.22em] text-orange-200/70">Core Stack</p>
              <p className="mt-3 text-lg font-semibold text-white">React • Laravel</p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5 backdrop-blur-xl transition duration-300 hover:border-orange-400/20 hover:bg-white/[0.07]">
              <p className="text-[11px] uppercase tracking-[0.22em] text-orange-200/70">Strength</p>
              <p className="mt-3 text-lg font-semibold text-white">UI / UX Thinking</p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5 backdrop-blur-xl transition duration-300 hover:border-orange-400/20 hover:bg-white/[0.07]">
              <p className="text-[11px] uppercase tracking-[0.22em] text-orange-200/70">Goal</p>
              <p className="mt-3 text-lg font-semibold text-white">Scalable Web Apps</p>
            </div>
          </div>

          <div className="mt-10 flex flex-wrap gap-4">
            <button className="rounded-full bg-orange-500 px-8 py-3.5 font-semibold text-white transition duration-300 hover:-translate-y-1 hover:bg-orange-400 hover:shadow-[0_0_35px_rgba(255,106,0,0.45)]">
              Read More
            </button>
            <button className="rounded-full border border-white/15 bg-white/5 px-8 py-3.5 font-semibold text-white backdrop-blur-md transition duration-300 hover:-translate-y-1 hover:border-orange-400/60 hover:bg-white/[0.07] hover:text-orange-300">
              Download CV
            </button>
          </div>
        </div>
