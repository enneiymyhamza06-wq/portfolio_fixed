...
import { cn } from "../lib/utils";  // ← غير المسار هكا بلا @
...
export function CardPattern({ mouseX, mouseY, randomString }) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-orange-500 to-yellow-500 opacity-0 group-hover/card:opacity-100 backdrop-blur-xl transition duration-500"
        style={style}
      />
      <motion.div
